...
class _$_MainSettings implements _MainSettings {
  const _$_MainSettings(
      {this.avatar = const AssetImage('assets/images/defaultPerson.jpg'),
  ...
  @override
  String toString() {
    return 'MainSettings(avatar: $avatar, isDarkMode: $isDarkMode, locale: $locale)';
  }
...
abstract class _MainSettings implements MainSettings {
  const factory _MainSettings(
      {final ImageProvider<Object>? avatar,
      final bool isDarkMode,
      final Locale? locale}) = _$_MainSettings;
